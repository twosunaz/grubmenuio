...
class ComposerStaticInitSnipVault
{
    ...
    public static $classMap = array (
        ...
        'SnipVault\\Ajax\\CLIExecutor' => __DIR__ . '/../..' . '/src/Ajax/CLIExecutor.php',
        'SnipVault\\App\\SnipVault' => __DIR__ . '/../..' . '/src/App/SnipVault.php',
        'SnipVault\\Core\\ConditionsEvaluator' => __DIR__ . '/../..' . '/src/Core/ConditionsEvaluator.php',
        'SnipVault\\Core\\PluginPackager' => __DIR__ . '/../..' . '/src/Core/PluginPackager.php',
        'SnipVault\\Core\\SnippetErrorHandler' => __DIR__ . '/../..' . '/src/Core/SnippetErrorHandler.php',
        'SnipVault\\Core\\SnippetExecutor' => __DIR__ . '/../..' . '/src/Core/SnippetExecutor.php',
        'SnipVault\\Options\\GlobalOptions' => __DIR__ . '/../..' . '/src/Options/GlobalOptions.php',
        'SnipVault\\Pages\\Editor' => __DIR__ . '/../..' . '/src/Pages/Editor.php',
        'SnipVault\\PostTypes\\Folders' => __DIR__ . '/../..' . '/src/PostTypes/Folders.php',
        'SnipVault\\PostTypes\\Snippets' => __DIR__ . '/../..' . '/src/PostTypes/Snippets.php',
        'SnipVault\\PostTypes\\SnippetsRevisons' => __DIR__ . '/../..' . '/src/PostTypes/SnippetsRevisons.php',
        'SnipVault\\Rest\\CLIEndpoint' => __DIR__ . '/../..' . '/src/Rest/CLIEndpoint.php',
        'SnipVault\\Rest\\ClaudeEndpoint' => __DIR__ . '/../..' . '/src/Rest/ClaudeEndpoint.php',
        'SnipVault\\Rest\\ErrorLog' => __DIR__ . '/../..' . '/src/Rest/ErrorLog.php',
        'SnipVault\\Rest\\ExportEndpoint' => __DIR__ . '/../..' . '/src/Rest/ExportEndpoint.php',
        'SnipVault\\Rest\\FileSystemEndpoint' => __DIR__ . '/../..' . '/src/Rest/FileSystemEndpoint.php',
        'SnipVault\\Rest\\SCSSCompiler' => __DIR__ . '/../..' . '/src/Rest/SCSSCompiler.php',
        'SnipVault\\Rest\\SQLEditorEndpoint' => __DIR__ . '/../..' . '/src/Rest/SQLEditorEndpoint.php',
        'SnipVault\\Update\\Updater' => __DIR__ . '/../..' . '/src/Update/Updater.php',
        'SnipVault\\Utility\\Scripts' => __DIR__ . '/../..' . '/src/Utility/Scripts.php',
    ...
    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInitSnipVault::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInitSnipVault::$prefixDirsPsr4;
            $loader->classMap = ComposerStaticInitSnipVault::$classMap;
