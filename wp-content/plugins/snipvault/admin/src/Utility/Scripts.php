...
class Scripts
{
   ...
   * for the 'snipvault.js' entry point. It uses WordPress file reading functions
  ...
  {
    $manifest_path = snipvault_plugin_path . "app/dist/.vite/manifest.json";
